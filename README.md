...
\033[1;92m..........................salmanhamz!!!!! BlackMafia......................
\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   Nigeria 🇳🇬 🇳🇬 🇳🇬 
\033[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 
...
def tik☠⃨():
	titik = ['.   ','... ']
	for o in titik:
		print("\r\x1b[1;93mHELLO NIGER\x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
id = []
listgrup = []
vulnot = "\0cyber security expert and analyst 
vuln = "\033[32mVuln"
...
print  """
 ...
 \033[1;96m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  \033[1;96m ─────────────•◈•──────────  
   \033[1;92m███████▒▒Welcome To  salmanhamz▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mBlackMafia\033[1;95m♡╭──────────•◈•──────────╮♡
...
CorrectUsername = "Salmanhamz "
CorrectPassword = "Salmanhamz "
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username salmanhamz
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_super():
	...
	print """
             ...
             ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤
♡──────────────•◈•──────────────♡.
: \033[1;96m .....salmanhamz  BlackMafia........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp number
               +08065634886"""
...
if __name__ Salmanhamz '__main__':
	login(Salmanhamz )
